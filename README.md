...
2.  Also do change the ip address of backend in the front-end application as well. For more details please check -(https://github.com/Praveenanirudh/FSD-CapStoneProject-MyMoviePlan-Frontend)
